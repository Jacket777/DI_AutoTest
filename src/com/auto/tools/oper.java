...
public class oper{
	...
	//6.特殊按钮点击：添加数据源，数据目标按钮点击
	  ...
	  * 向下滑动页面
	  */
	  public static void drawToBottom(ChromeDriver driver) {
	   ...
	   * 功能说明：判断下拉框是否为目标下拉框
	   */
	  public static boolean confirmSelect(Select select,String confirmText) {
	   ...
	   * 0:确认，1 取消
	   */
	  public static void AlertOP(ChromeDriver driver,int i) {
